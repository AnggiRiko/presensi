...
// Mengambil data lokasi presensi dari database
$lokasi_presensi = $_SESSION['lokasi_presensi'];
$result = mysqli_query($connection, "SELECT * FROM lokasi_presensi WHERE nama_lokasi = '$lokasi_presensi'");

// Menetapkan variabel-variabel yang diperlukan dari data lokasi presensi
...
// Menyesuaikan zona waktu berdasarkan data lokasi presensi
if ($zona_waktu == 'WIB') {
            ...
            <div class="col-md-4">
                <div class="card text-center h-100">
                    ...
                    <div class="card-body">
                        ...
                        // Mengecek apakah presensi masuk sudah dilakukan pada hari ini
            ...
            <div class="col-md-4">
                <div class="card text-center h-100">
                    ...
                    <div class="card-body">
                        ...
                        // Mengecek apakah waktu sudah sesuai untuk presensi keluar
                        ...
                        <?php } elseif (strtotime($waktu_sekarang) >= strtotime($jam_pulang) && mysqli_num_rows($ambil_data_presensi) == 0) { ?>
                            <i class="fa-regular fa-circle-xmark fa-4x text-danger"></i>
                            <h4 class="my-3">Silahkan melakukan presensi masu <br> terlebih dahulu.</h4>
                        <?php } else { ?>
...
<script>
    ...
    // Mendapatkan lokasi (koordinat) pengguna
    getLocation();
