...
$judul = "Data Ketidakhadiran"; // Menetapkan judul halaman
include('../layout/header.php'); // Memasukkan file header.php
require_once('../../config.php'); // Memasukkan file konfigurasi

// Mengambil data ketidakhadiran dari database, diurutkan berdasarkan ID secara descending
                ...
                while ($data = mysqli_fetch_array($result)) : ?>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <?php else : ?>
                                <a class="badge badge-pill bg-success" href="<?= base_url('admin/data_ketidakhadiran/detail.php?id=' . $data['id']) ?>">APPROVER</a>
                            <?php endif; ?>
                        </td>
                    </tr>
                <?php endwhile; ?>
